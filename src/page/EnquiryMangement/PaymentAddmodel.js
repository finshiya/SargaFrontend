...
// import GPImage from './img/GP.png';
...
//   console.log('expandible FollowUp', selectedData);
...
//         const response = await axios.post('http://localhost:3000/payments', values);
...
//           <Form.Label style={{ fontSize: '14px' }}>Payment Date</Form.Label>
//           <Form.Control
//             type="date"
...
//           <Form.Label style={{ fontSize: '14px' }}>Payment Amount</Form.Label>
//           <Form.Control
//             type="text"
//             name="paymentAmount"
...
//             <div className="error" style={{ color: 'red' }}>{formik.errors.paymentAmount}</div>
//           ) : null}
//         </Form.Group>
//       </Col>
...
//           <Form.Label style={{ fontSize: '14px' }}>Payment Method</Form.Label>
//           <Form.Control
//             type="text"
//             name="paymentMethod"
...
//           <Form.Label style={{ fontSize: '14px' }}>Transaction ID</Form.Label>
//           <Form.Control
//             type="text"
//             name="transactionId"
...
//             <div className="error" style={{ color: 'red' }}>{formik.errors.transactionId}</div>
//           ) : null}
//         </Form.Group>
//       </Col>
...
//             <img src={GPImage} alt="Google Pay Screenshot" className="lightbox-image" />
//           </Modal.Body>
//         </Modal>
//       )}
//     </>
